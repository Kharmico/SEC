...
konsole -e "bash -c \"java -cp ./lib/*:./lib/Jersey-bundle_lib/*:./src/:. Client.ClientApp http://localhost:8000/ http://localhost:8500/ http://localhost:9000/ http://localhost:9500/ < ./fileForTest2.txt; exec bash\""
