...
konsole -e "bash -c \"java -cp ./lib/*:./lib/Jersey-bundle_lib/*:./src/:. Server.ByzantineServer 9500 http://localhost:8000/ http://localhost:8500/ http://localhost:9000/ http://localhost:9500/; exec bash\""
